...
np.save('./saved_lists/transposed_lists/tlabels_sub_carver_img.npy', transposed_labels)
np.save('./saved_lists/transposed_lists/tpredictions_sub_carver_img.npy', transposed_predictions)